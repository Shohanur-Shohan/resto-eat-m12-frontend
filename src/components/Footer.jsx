          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5 max-w-[1536px] mx-auto px-4 lg:px-7.5 xl:px-10 pb-4 pt-8">
            <div className="justify-center col-span-1 text-center sm:text-left sm:justify-start md:justify-start lg:col-span-2">
              <div className="">
                ...
                <ul className="mt-8">
                  <li className="my-2 text-secondary ">
            ...
            <div className="flex justify-center col-span-1 text-center sm:text-left sm:justify-start md:justify-end">
              <div>
                <h4 className="text-2xl font-semibold text-secondary font-opensans">
                  Quick Links
                </h4>
                <div className="grid mt-3 space-y-3">
                  <p>
                    <a className="inline-flex text-secondary gap-x-2 " href="#">
                      Home
                    </a>
                  </p>
                  <p>
        ...
        <div className="w-full bg-[#0F172A]">
          <div className="grid sm:gap-y-0 sm:flex sm:justify-between sm:items-center max-w-[1536px] mx-auto px-4 lg:px-7.5 xl:px-10 pb-6 pt-6">
            <div className="flex items-center justify-between">
              <p className="mx-auto text-sm text-white sm:m-0">
            ...
            <div className="mx-auto sm:mx-0">
              <a
                className="inline-flex items-center justify-center text-sm font-semibold text-white border border-transparent rounded-lg size-10 gap-x-2 hover:bg-white/10 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:ring-1 focus:ring-gray-600"
                href="#"
              >
                <svg
